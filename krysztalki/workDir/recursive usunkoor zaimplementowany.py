...
#         self.symmetry_mask_cell = self.check_symmetries_in_cell()
...
#     def check_symmetries_in_cell( self
...
#         """
#     # calculate all possible cell transformations 
#         matrices = self.myCell.symmetry_operations[mask_TOBEMADE]

#         transformed_points = self.myCell.super_cell @ matrices
...
#         # put points back into cell
#         transformed_points_sorted2 = put_points_in_cell(transformed_points_sorted)

#         # check for which symmetries the cell is the same
#         return np.array(
#             [np.array_equal(points, self.myCell.super_cell) for points in transformed_points_sorted2]
#         )
...
#         self.Temp_name_MyCell = MyCell(
#             self.file, self.size
#         )


#         # self.cell, self.atoms_labels, _, _, self.base_type = MyCell(
#         #     self.file, self.size
#         # )
#         self.cell_indexes = np.arange(self.Temp_name_MyCell.super_cell.shape[0]) # TODO: Refactor
#         self.unchanged_cell_aka_root = ReducedCell(self.Temp_name_MyCell)

...
def usunkoor_mod_3(koorZEW, MM=None):  # , Matrixes):
    mat = (
        MM.generateSymetryBaseQUAD()
    )  # przesia symetrie dla idealnej siecie krysstalicznej
...
def usunkoor_mod_2(koorZEW, MM=None):  # , Matrixes):
    mat = (
        MM.generateSymetryBaseQUAD()
    )  # przesia symetrie dla idealnej siecie krysstalicznej
    allsyms = MM.makelist(mat)
